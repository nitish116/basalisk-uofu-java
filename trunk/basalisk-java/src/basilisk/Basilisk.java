 ...
 * 			more seed files.
 * 
 * 			Example contents seed slist:
 * 			-----start content of file my_seeds.slist---------
 * 			seeds/MUC4-terrorism/
 * 			human.seeds
 * 			vehicles.seeds
 * 			weapon.seeds
 * 			-----end content of file my_seeds.slist---------
 * 
 * <all_cases_file>
 ...
 *  		------start of sample all_cases_file -----------------
 ...
 *          
 *          -s 	[0 or 1] 				Runs Basilisk in "Snowball" mode. That is, Basilisk will only select the
...
public class Basilisk {
	...
	/**
	 * Initializes basilisk with the given input arguments. 
	 * 
	 * Input arg ordering:
	 * <pre>
